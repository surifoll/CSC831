...
namespace HopfieldAssiggnmentCSC831
{
    /// <summary>
    ...
    /// <seealso cref="HopfieldAssiggnmentCSC831.Neuron"/>
    /// <seealso cref="HopfieldAssiggnmentCSC831.NeuralNetwork"/>
    ...
    public class NeuralNetwork
    {
        ...
        {
            List<Neuron> randomPattern = new List<HopfieldAssiggnmentCSC831.Neuron>(n);
